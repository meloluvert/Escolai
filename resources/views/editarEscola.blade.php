    ...
    <form>
        ...
        <div style="display:flex">
            <div class="mb-3" style="align-items: center; justify-content: center;">
                ...
                <input type="number" class="form-control" id="nalunos" aria-describedby="emailHelp">
            </div>
            <div class="mb-3" style="align-items: center; justify-content: center;">
                <label for="exampleInputEmail1" class="form-label">Média de Mensalidade*</label>
                <input type="number" class="form-control" id="mensalidade">
            </div>
        </div>
        <div class="mb-3" style="align-items: center; justify-content: center;">
        ...
        <div class="mb-3" style="align-items: center; justify-content: center;">
            ...
            <input type="tel" class="form-control" id="cpfcoordenador">
        </div>
        <div style="display:flex">
            <div class="mb-3" style="align-items: center; justify-content: center;">
